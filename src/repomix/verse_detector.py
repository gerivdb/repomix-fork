...
class UniversalVerseDetector:
    ...
    def get_known_matrices(self) -> List[VerseObservation]:
        return [
            VerseObservation(name="PHYSIC-VERSE", score=0.89, status=VerseStatus.MATURE, nodes=118, edges=13806),
            VerseObservation(name="BIO-VERSE", score=0.81, status=VerseStatus.BORN, nodes=214000000, edges=1200000000),
            VerseObservation(name="MATH-VERSE", score=0.78, status=VerseStatus.BORN, nodes=30000000, edges=210000000),
            VerseObservation(name="SEMANTIC-VERSE", score=0.76, status=VerseStatus.CATALYZING, nodes=14000000, edges=110000000),
        ]
